...
/**
 * TODO Automatically add current user to user's list.
 * TODO Fix deleting groups, so that they don't continue to show up on startup.
 * TODO Fix adding reminders to groups, so that they show up on startup.
 * TODO Fix deleting reminders, so that they don't continue to show up on startup.
 * TODO Fix adding reminders to pre-existing groups, so that they are saved to that group.
 * TODO Keep showing pre-existing reminders after creating new reminder.
 *
 * Created by dsalov2 on 04/30/2017.
 *
 * The main window that displays the groups for the logged-in user.
 */
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    /**
     * Keeps the user from going back to the log-in screen.
     */
    @Override
